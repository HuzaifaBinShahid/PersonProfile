  ...
  return (
    <section id="box" className='py-5'>
      <div className="container mx-auto max-w-[500px] relative">
        ...
        <div className="card shadow-lg rounded-[20px] p-4">

          <div className="image absolute top-12 left-1/2 transform -translate-x-1/2 transition-transform duration-500 hover:scale-110">
          ...
          <div className="buttons flex justify-center gap-x-5 py-5 ">
            <button className='bg-[#3F70F4] text-white text-[20px] font-semibold px-7 py-3 rounded-full transition-transform duration-300 ease-in-out hover:scale-95'>Subscribe</button>
            <button className='bg-[#3F70F4] text-white text-[20px] font-semibold px-7 py-3 rounded-full transition-transform duration-300 ease-in-out hover:scale-95'>Message</button>
          </div>
